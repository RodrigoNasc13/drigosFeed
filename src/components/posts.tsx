export function Post() {
  return (
    <div className="bg-zinc-800 rounded-lg p-4 space-y-6 lg:p-10">
      ...
      <div>
        <div className="space-y-4">
          ...
          <textarea
            className="w-full max-h-[6rem] p-4 resize-none outline-none text-sm text-neutral-400 bg-neutral-900 rounded-lg lg:text-base  "
            placeholder="Escreva aqui o seu comentário..."
          />
          <div className="flex justify-center lg:justify-start">
            <button className="px-6 py-3 text-neutral-200 bg-emerald-600 rounded-lg font-bold">
              Publicar
            </button>
          </div>
        </div>
